...
type MariaDBBindingSpec struct {
	...
	// Foo is an example field of MariaDBBinding. Edit mariadbbinding_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// MariaDBBindingStatus defines the observed state of MariaDBBinding
type MariaDBBindingStatus struct {
...
type MariaDBBinding struct {
	...
	Status MariaDBBindingStatus `json:"status,omitempty"`
}
