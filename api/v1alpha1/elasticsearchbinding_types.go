...
type ElasticsearchBindingSpec struct {
	...
	// Foo is an example field of ElasticsearchBinding. Edit elasticsearchbinding_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// ElasticsearchBindingStatus defines the observed state of ElasticsearchBinding
type ElasticsearchBindingStatus struct {
...
type ElasticsearchBinding struct {
	...
	Status ElasticsearchBindingStatus `json:"status,omitempty"`
}
