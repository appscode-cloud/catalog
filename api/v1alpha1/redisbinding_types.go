...
type RedisBindingSpec struct {
	...
	// Foo is an example field of RedisBinding. Edit redisbinding_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// RedisBindingStatus defines the observed state of RedisBinding
type RedisBindingStatus struct {
...
type RedisBinding struct {
	...
	Status RedisBindingStatus `json:"status,omitempty"`
}
