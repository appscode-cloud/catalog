...
type MongoDBBindingSpec struct {
	...
	// Foo is an example field of MongoDBBinding. Edit mongodbbinding_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// MongoDBBindingStatus defines the observed state of MongoDBBinding
type MongoDBBindingStatus struct {
...
type MongoDBBinding struct {
	...
	Status MongoDBBindingStatus `json:"status,omitempty"`
}
